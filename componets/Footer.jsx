...
const Footer = () => {
  return (
    <>
    <div className='xl:w-full xl:h-226.5 bg-primary flex flex-col gap-10 justify-items-center justify-center lg:w-5xl lg:h-358.5 md:w-192 md:h-358.5 sm:w-150 sm:h-358.5'>

        <div className=' ml-10 xl:w-315 xl:h-164 flex xl:flex-col gap-12 justify-items-center justify-self-center lg:flex-col lg:gap-2.5 lg:w-211 lg:h-287.5 md:w-176 md:h-287 sm:w-108 md:flex-col sm:flex-col  sm:h-287.5'>
       ...
       {/* innerDIV */}
        <div className='   xl:w-266.5 xl:h-164 xl:-mt-5 flex xl:flex-row xl:gap-10 justify-center justify-self-center  lg:flex-col lg:mt-10 lg:w-211   md:flex-col md:gap-10  md:w-111.5 md:h-258.5 sm:w-108  sm:flex-col sm:h-287.5'>
            {/* first-row */}
            <div className='flex xl:flex-col gap-16 lg:flex-row md:flex-row sm:flex-row'>
            ...
            {/* second-row */}
            <div className='xl:flex xl:flex-col gap-16 lg:flex-row md:flex-row sm:flex-row xl:w-50.5'>
                <div className='flex flex-col gap-6 xl:w-45' >
            ...
            <div className='flex flex-col xl:gap-27'>
                <div className='xl:flex flex-col gap-6 lg:hidden md:hidden sm:hidden' >
                    <p className='font-Roboto font-semibold text-xl leading-5 text-backgroundWHITE'>Subscribe to Our Newsletter</p>
                    <p className='font-Roboto font-normal text-base leading-4 text-backgroundWHITE'>Get the latest updates on properties, market trends, and
                    exclusive offers. </p>
        ...
        <div className='flex flex-col gap-1 justify-baseline md:mt-6'>
