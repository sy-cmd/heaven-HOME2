    ...
    <div className='xl:w-full xl:gap-3.5 xl:h-226.5 bg-primary flex flex-col gap-10 justify-items-center justify-center lg:w-5xl lg:h-358.5 md:w-192 md:h-358.5 sm:w-150 sm:h-358.5 max-xs:justify-center'>
       ...
       {/* innerDIV */}
        <div className='   xl:w-266.5 xl:h-164 xl:mt-5 flex xl:flex-row xl:gap-40 xl:ml-6.5 justify-center justify-self-center  lg:flex-col lg:mt-10 lg:w-211   md:flex-col md:gap-10  md:w-111.5 md:h-258.5 sm:w-108  sm:flex-col sm:h-287.5 max-xs:flex-col max-xs:gap-10 max-xs:w-[363px] max-xs:h-[1254px] max-xs:mt-0'>
            ...
            {/* second-row */}
            <div className='xl:flex xl:flex-col gap-16 lg:flex-row md:flex-row sm:flex-row xl:w-50.5 max-xs:flex-row max-xs:gap-5 max-xs:hidden'>
                
                <div className='flex flex-col gap-6 xl:w-45 max-xs:w-[180px] max-xs:h-[195px]' >
                ...
                <div className='flex flex-col gap-6 max-xs:w-[114px] max-xs:h-[281px]' >
            ...
            {/* below 640px */}
            <div className='flex flex-row gap-2.5 sm:hidden'>
                ...
                <div className='flex flex-col gap-3 max-xs:w-[114px] max-xs:h-[281px] ' >
                    <p className='font-Roboto font-semibold text-xl leading-5 text-backgroundWHITE'>About Lands</p>
                    <p className='font-Roboto font-normal text-base leading-4 text-backgroundWHITE'>Resort land</p>
                    <p className='font-Roboto font-normal text-base leading-4 text-backgroundWHITE'>Farm land</p>
                    <p className='font-Roboto font-normal text-base leading-4 text-backgroundWHITE'>Ranch land</p>
            ...
            <div className='flex flex-col xl:gap-27'>
                <div className='xl:flex flex-col gap-6 lg:hidden md:hidden sm:hidden max-xs:hidden' >
                    <p className='font-Roboto font-semibold text-xl leading-5 text-backgroundWHITE'>Subscribe to Our Newsletter</p>
                    <p className='font-Roboto font-normal text-base leading-4 text-backgroundWHITE'>Get the latest updates on properties, market trends, and
                    exclusive offers. </p>
