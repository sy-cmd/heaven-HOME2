...
const Footer = () => {
  return (
    <>
    <div className='xl:w-full xl:h-226.5 bg-primary flex flex-col gap-10 justify-items-center justify-center lg:w-5xl lg:h-358.5 md:w-192 md:h-358.5 max-sm:w-150 max-sm:h-358.5 xs:w-full xs:h-394.5 xs:flex-col'>

        {/* below-390px */}
        <div className='flex flex-col w-91 h-342.5 gap-10 md:hidden lg:hidden xl:hidden'>
        ...
        <div className=' xs:hidden ml-10 xl:w-315 xl:h-164 flex xl:flex-col gap-12 justify-items-center justify-self-center lg:w-211 lg:h-287.5 md:w-176 md:h-287 max-sm:w-108  max-sm:h-287.5'>
            <div className='flex flex-row gap-1  justify-items-center '>
                <img className='w-16 h-15 rounded-xl py-1 px-2' src={logo} alt="logo" srcset="" />
                <p className=' mt-4 text-3xl font-Roboto font-extrabold leading-9 text-backgroundWHITE'>Haven Homes</p>
            </div>
       ...
       {/* innerDIV */}
        <div className=' xs:hidden  xl:w-266.5 xl:h-164 xl:-mt-5 flex xl:flex-row xl:gap-10 justify-center justify-self-center lg:flex-col lg:mt-30 lg:w-211   md:flex-col md:gap-10  md:w-111.5 md:h-258.5 max-sm:w-108  max-sm:flex-col max-sm:h-287.5'>
            {/* first-row */}
            <div className='flex xl:flex-col gap-16 lg:flex-row md:flex-row max-sm:flex-row'>
                <div className='flex flex-col gap-6 xl:w-45' >
                    <p className='font-Roboto font-semibold text-xl leading-5 text-backgroundWHITE'>Deal with us</p>
