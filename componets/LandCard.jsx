...
const LandCard = () => {
  return (
    <>
     ...
     <div className='w-243.5 h-105.5 rounded-xl bg-Cardc border-20 border-backgroundWHITE flex flex-row gap-7 justify-center items-center justify-self-center lg:w-165.5 lg:h-212.5 lg:flex-wrap md:w-132 md:h-218 md:flex-wrap max-sm:w-76 max-sm:h-335.5 max-sm:flex-col xl:flex-row xl:w-243.5 xl:h-106'>
        <div className='w-68 h-86 rounded-xl p-6 bg-backgroundWHITE drop-shadow-md flex flex-col gap-3 md:w-56 md:h-98 max-sm:w-56 max-sm:h-98 xl:w-68 xl:h-86 '>
        ...
        <div className='w-68 h-86 rounded-xl p-6 bg-backgroundWHITE drop-shadow-md flex flex-col gap-4 md:w-56 md:h-98 md:-mt-5.5 max-sm:w-56 max-sm:h-98 xl:w-68 xl:h-86  xl:mt-0'>
            <div className='flex items-center justify-self-center justify-center'>
