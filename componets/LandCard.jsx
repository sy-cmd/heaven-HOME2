...
const LandCard = () => {
  return (
    <>
     ...
     <div className='w-243.5 h-105.5 rounded-xl bg-Cardc border-20 border-backgroundWHITE flex flex-row gap-7 justify-center items-center justify-self-center lg:w-165.5 lg:h-212.5 lg:flex-wrap md:w-132 md:h-218 md:flex-wrap sm:w-76 sm:h-335.5 sm:flex-col xl:flex-row xl:w-243.5 xl:h-106'>
