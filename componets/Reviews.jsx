   ...
   <div className='xl:w-317 xl:h-276 flex flex-col gap-3 justify-self-center lg:w-211 lg:h-380.5 md:w-176 md:h-502 sm:w-134 sm:h-405.5'>
    ...
    <div className='xl:w-317 xl:h-136.5 flex flex-row gap-3 lg:w-211 lg:h-192 lg:gap-3 lg:items-center md:w-176 md:h-160.5 sm:w-134 sm:h-204.5'>
        ...
        <div className='xl:w-103.5 xl:h-136.5 flex flex-col p-5 gap-3 bg-backgroundWHITE rounded-xl lg:flex lg:w-70.5 lg:h-192 lg:gap-1 md:w-86.5 md:h-160.5 sm:w-65.5 sm:h-204.5'>
            ...
            <div>
            <p className='font-Roboto font-normal leading-6 text-base text-bartext4 max-lg:w-76.5 max-lg:h-119 sm:w-55.5 sm:h-162.5 '>
        ...
        <div className=' lg:flex xl:w-103.5 xl:h-136.5 flex flex-col gap-5 lg:w-70.5 lg:h-192 md:w-86.5 md:h-161 sm:w-65.5 sm:h-204.5 '>
            ...
            {/* inersecond */}
            <div className='xl:w-103.5 xl:h-66.5 rounded-xl p-5 bg-backgroundWHITE flex flex-col gap-2.5 lg:w-70.5 lg:h-94.5 md:w-86.5 md:h-79 sm:w-65.5 sm:h-101 sm:gap-13' >
            <div className='flex flex-row gap-3 justify-items-center'>
    ...
    <div className='xl:w-317 xl:h-136.5 flex flex-row gap-3 lg:flex lg:w-211  lg:h-192 lg:gap-3 lg:items-center md:w-176 md:h-160.5 sm:w-134 sm:h-204.5'>
        ...
        <div className=' xl:w-103.5 xl:h-136.5 xl:flex flex-col gap-5 lg:flex lg:w-70.5  lg:h-192 md:hidden sm:w-65.5 sm:h-198 '>
            <div className='xl:w-103.5 xl:h-66.5 rounded-xl p-5 bg-backgroundWHITE flex flex-col gap-2.5 lg:w-70.5 lg:h-94.5 sm:w-65.5  sm:h-97.5 sm:gap-8' >
            <div className='flex flex-row gap-3 justify-items-center'>
                <img className='w-17 h-17 rounded-4xl' src={P6} alt="" srcset="" />
                <div className='flex flex-col gap-1 mt-4'>
                    <p className='font-Roboto font-semibold text-base leading-4 text-black' >Cody Fisher</p>
