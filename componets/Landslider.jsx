...
const Landslider = () => {
  return (
    ...
    <div className='xl:w-274 xl:h-22.5 rounded-3xl py-3 px-5 bg-backgroundWHITE flex flex-row gap-10 justify-center justify-self-center lg:w-190 md:w-145.5 sm:w-108 ' >
        {/* first */}
        <div className='w-64.5 h-16.5 rounded-xl py-2 pr-7 pl-2 bg-primary flex flex-row drop-shadow-lg gap-2 '>
            ...
            <div className='mt-2.5'>
                <p className='font-Roboto font-medium text-2xl text-backgroundWHITE sm:hidden'>  All Land Types</p>
                <p className='font-Roboto font-medium text-xl text-backgroundWHITE xl:hidden md:hidden'>  All Types</p>
        ...
        <div className='w-57 h-16.5 rounded-xl py-2 pr-7 pl-2 bg-Cardc flex flex-row drop-shadow-lg gap-2 lg:hidden xl:flex'>
            ...
            <div className='mt-2.5'>
                <p className='font-Roboto font-medium text-2xl text-bartext sm:hidden xl:flex'>  Ranch Land</p>
                <p className='font-Roboto font-normal text-base text-bartext xl:hidden md:hidden'>  Ranch Land</p>
          

            </div>
        </div>
        {/* third */}
        <div className='w-57 h-16.5 rounded-xl py-2 pr-7 pl-2 bg-Cardc flex flex-row drop-shadow-lg gap-2 md:hidden sm:hidden xl:flex'>
    ...
    <div className=' mt-3    w-280 h-114 rounded-xl flex justify-items-center  justify-self-center items-center lg:w-192 lg:h-116 md:w-145.5  sm:w-104 sm:h-116   xl:w-243.5' >
