...
const TextBar1 = () => {
  return (
    <>
    <div className='xl:w-252 xl:h-39.5 flex flex-col gap-5 items-center justify-self-center mt-20 mb-20 lg:w-177 lg:h-43.5 md:w-176 md:h-44 sm:w-134 sm:h-44.5 max-xs:w-[363px] max-xs:h-[210px] '>
