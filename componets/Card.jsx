...
const Card = () => {
  return (
   <>
   <div className='w-227.5 h-136 border-20 border-backgroundWHITE p-4 rounded-xl flex flex-col gap-3 justify-self-center items-center  bg-Cardc lg:w-158 lg:h-198 lg:flex-row lg:gap-4'>
