...
const Card = () => {
  return (
   <>
   <div className='xl:w-227.5 xl:h-136 border-20 border-backgroundWHITE p-4 rounded-xl flex xl:flex-col gap-3 justify-self-center items-center  bg-Cardc lg:w-158 lg:h-198 max-lg:flex-row lg:gap-4 md:w-158 md:h-198 md:flex-row sm:w-84.5 sm:h-141.5 '>

    <div className='flex xl:flex-row gap-3 lg:flex-col md:flex-col sm:flex-col max-sm:gap-5'>
        ...
        <div className='bg-backgroundWHITE w-68 h-58 rounded-xl p-6 flex flex-col gap-4 drop-shadow-md sm:hidden'>
    ...
    <div className='flex xl:flex-row gap-3 lg:flex-col md:flex-col sm:hidden '>
        <div className='bg-backgroundWHITE w-68 h-58 rounded-xl p-6 flex flex-col gap-4 drop-shadow-md'>
        <LuHammer size={33} color='#0A2540' />
            <h5 className='text-xl font-semibold font-Roboto leading-5 text-primary'>Quality</h5>
